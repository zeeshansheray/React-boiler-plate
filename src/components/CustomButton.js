...
export default function CustomButton({
  ...
  const propsObj = {
    className: className,
    // backgroundColor : varient ? varient === 'secondary' ? '' : varient === 'primary' ? '' : varient === 'warning' ? '' : varient === 'warningSecondary' : '',
    // hover           : getHoverColor[backgroundColor] || utils.getHoverColor(ColorSchemeCode.brandingPrimaryColor),
    // focus           : getFocusColor[backgroundColor || ColorSchemeCode.themeColor],
    // color           : backgroundColor ? utils.invertColor(backgroundColor,{ black: 'black', white: 'white' }) : utils.invertColor(ColorSchemeCode.brandingPrimaryColor,{ black: 'black', white: 'white' }),
    ...props,
  };
