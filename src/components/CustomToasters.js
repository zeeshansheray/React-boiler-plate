                            ...
                            >
                                ...
                                <div className="d-flex">
                                    ...
                                    {/* <div> */}
                                        ...
                                        {/* <p className="notification-message capitalize Caption12R color-GeneralBlack">{'You cannot edit the tier now. Customers have enrolled, which will cause customer loss.'}</p> */}
                                    {/* </div> */}
                                </div>
                            </div>
                        </Fade>
